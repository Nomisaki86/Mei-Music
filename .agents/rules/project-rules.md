...
- **Comments and documentation are mandatory**: Every maintained source file must include a short high-level summary, and all non-trivial logic blocks/methods must have clear comments explaining intent, data flow, and side effects so a new programmer can understand the code quickly.
